 ...
 *
 * Properties are redeclared for their attributes only: the parent ones carry
 * the postal address templates, and PHP attributes are not inherited per
 * property. This replaces the field configurator that used to patch these
 * microdata by hand, on the object side.
 */
#[SPL\SplashObject(
    name: "Delivery Address",
    description: "Sellsy Delivery Address API Object",
    ico: "fa fa-truck"
)]
